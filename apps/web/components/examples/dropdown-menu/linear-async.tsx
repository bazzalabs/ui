...
const projectStatusTypeMenu: DropdownSubmenuDef = {
  kind: 'submenu',
...
const projectPriorityMenu: DropdownSubmenuDef = {
  kind: 'submenu',
  id: 'project-priority',
...
const projectLabelsMenu: DropdownSubmenuDef = {
  kind: 'submenu',
  id: 'project-labels',
  icon: <LabelsIcon />,
...
const projectLeadMenu: DropdownSubmenuDef = {
  kind: 'submenu',
  id: 'project-lead',
...
const priorityMenu: DropdownSubmenuDef = {
  kind: 'submenu',
  id: 'priority',
  icon: <ProjectPriorityIcon />,
  title: 'Priority',
