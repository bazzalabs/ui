...
import { ActionMenu, LabelWithBreadcrumbs } from '@/registry/ui/action-menu'

export function ActionMenu_ItemDescriptions() {
  ...
  const flattenedNodes = useMemo(() => flatten(nodes), [nodes])
