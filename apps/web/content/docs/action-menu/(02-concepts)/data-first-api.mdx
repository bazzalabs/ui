...
- **[Quick Examples](/docs/action-menu/examples)** - Common patterns
- **[Node Types](/docs/action-menu/node-types)** - Deep dive into each node type
- **[API Reference](/docs/action-menu/typescript)** - Complete TypeScript reference
