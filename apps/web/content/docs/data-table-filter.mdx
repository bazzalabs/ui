...
<ComponentFrame 
  containerClassName='overflow-hidden w-full 2xl:mx-0' 
...
- The filtering logic is provided as an npm package, `@bazzaui/filters`, which you can add directly to your project to handle all the backend filtering operations.
