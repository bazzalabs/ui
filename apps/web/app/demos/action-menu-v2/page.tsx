...
import type { ColumnOption, ColumnOptionExtended } from '@bazzaui/filters'
...
export default function Page() {
  ...
  const menuData: MenuData<{ icon: ColumnOption['icon'] }> = {
    id: 'issue-properties',
        ...
        <div className="px-4 py-2 max-w-screen-xl w-full mx-auto border-border border-dashed xl:border-x flex-1">
          <div className="flex flex-col gap-8 p-8">
            ...
            <FilterMenu.Root>
              ...
              <FilterMenu.Positioner side="bottom">
                <FilterMenu.Content menu={menuData} />
