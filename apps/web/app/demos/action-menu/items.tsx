...
type BaseNode = {
  ...
  label?: string
  icon?: Iconish
  keywords?: string[] // ends up as aliases for search
  disabled?: boolean
}

export type MenuItemNode = BaseNode & {
  kind: 'item'
  value?: string // defaults to id
  onSelect?: (value: string, node: MenuItemNode) => void
}

export type MenuSubmenuNode = BaseNode & {
  kind: 'submenu'
  children: MenuNode[]
}

export type MenuNode = MenuItemNode | MenuSubmenuNode

export const statuses: MenuNode[] = [
  {
    kind: 'item',
    id: 'icebox',
    label: 'Icebox',
...
export const properties: MenuNode[] = [
  {
    kind: 'submenu',
    id: 'status',
    label: 'Status',
    icon: ({ className, ...props }: React.HTMLAttributes<SVGSVGElement>) => (
      <svg
        className={cn(
