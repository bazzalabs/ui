...
export default function ServerDataViewsExamplePage() {
  return (
          ...
          <div className="flex flex-col gap-8 p-8">
            <div>
              <h1 className="text-4xl font-[538] tracking-[-0.03rem] select-none">
                Data View{' '}
                <span className="text-muted-foreground">(Server-Side)</span>
              </h1>
              <p className="text-muted-foreground mt-2 text-sm">
                Server-side filtering, sorting, and pagination powered by{' '}
                <code className="text-xs bg-muted px-1.5 py-0.5 rounded">
                  @bazza-ui/data-view/drizzle/pg
                </code>{' '}
                — real PostgreSQL queries via Drizzle ORM + Neon.
              </p>
            </div>
            <IssuesTable />
          </div>
