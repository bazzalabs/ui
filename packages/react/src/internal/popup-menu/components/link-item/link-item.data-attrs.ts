export enum PopupMenuLinkItemDataAttributes {
  /**
   * Identifies the component part.
   * @type {'bazzaui-dropdown-menu-link-item' | 'bazzaui-context-menu-link-item' | 'bazzaui-command-menu-link-item'}
   */
  slot = 'bazzaui-[component]-link-item',
  /**
