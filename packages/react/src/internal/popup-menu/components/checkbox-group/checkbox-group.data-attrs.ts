export enum PopupMenuCheckboxGroupDataAttributes {
  /**
   * Identifies the component part.
   * @type {'bazzaui-dropdown-menu-checkbox-group' | 'bazzaui-context-menu-checkbox-group' | 'bazzaui-command-menu-checkbox-group'}
   */
  slot = 'bazzaui-[component]-checkbox-group',
  /**
