...
export interface DropdownMenuRadioItemIndicatorState
...
export interface DropdownMenuRadioItemIndicatorProps
  extends ComponentProps<'span', DropdownMenuRadioItemIndicatorState> {
  /**
...
>(function DropdownMenuRadioItemIndicator(props, forwardedRef) {
  const {
    keepMounted = false,
    render,
    className,
  ...
  const state: DropdownMenuRadioItemIndicatorState = React.useMemo(
...
export namespace DropdownMenuRadioItemIndicator {
  export type State = DropdownMenuRadioItemIndicatorState
  export interface Props extends DropdownMenuRadioItemIndicatorProps {}
}
