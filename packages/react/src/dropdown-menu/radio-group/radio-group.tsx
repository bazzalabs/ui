...
} from '../contexts/radio-group-context.js'
import { GroupContext, useSurfaceContext } from '../contexts/surface-context.js'
import { DropdownMenuRadioGroupDataAttributes } from './radio-group.data-attrs.js'

export interface DropdownMenuRadioGroupState extends Record<string, unknown> {
  /**
...
export interface DropdownMenuRadioGroupProps<T = unknown>
  extends ComponentProps<'div', DropdownMenuRadioGroupState> {
  /**
...
const stateAttributesMapping = {
  disabled: (value: unknown) =>
    value ? { [DropdownMenuRadioGroupDataAttributes.disabled]: '' } : null,
}
...
export const DropdownMenuRadioGroup = React.forwardRef(
  function DropdownMenuRadioGroup<T>(
    ...
    const state: DropdownMenuRadioGroupState = React.useMemo(
      () => ({ disabled }),
      [disabled],
    )
  ...
  props: DropdownMenuRadioGroupProps<T> & React.RefAttributes<HTMLDivElement>,
) => React.ReactElement | null

export namespace DropdownMenuRadioGroup {
  export type State = DropdownMenuRadioGroupState
  export interface Props<T = unknown> extends DropdownMenuRadioGroupProps<T> {}
}
