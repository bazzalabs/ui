// @bazza-ui/data-view — Column Data Service
...
export class ColumnDataService<TData> {
  ...
  computeBaseOptions<TType extends ColumnDataType, TVal>(
    ...
    throw new Error(
      `[data-view] [${column.id}] Either provide static options, a transformValueToOptionFn, or ensure the column data conforms to ColumnOption type`,
    )
  }
