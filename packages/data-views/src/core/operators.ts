// @bazza-ui/data-views — Operator Utilities
 ...
 */
export function getOperatorSet(column: OperatorSetColumn): OperatorSet {
  ...
  throw new Error(
    `[data-views] No operator set found for column type "${column.type}". ` +
