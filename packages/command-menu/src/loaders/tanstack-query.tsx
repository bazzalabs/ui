 ...
 *
 * @example Usage with createCommandMenu
 * ```tsx
...
/**
 * Creates a type-safe async loader for command-menu that integrates with React Query.
 *
 ...
 * @returns A typed loader function compatible with command-menu
 *
 * @example Basic usage
 * ```tsx
