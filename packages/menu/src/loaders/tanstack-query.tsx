...
/**
 * React Query adapter for menu loaders.
 * Implements the LoaderAdapter interface using React Query hooks.
 * Can be used with command-menu, context-menu, action-menu, or any other menu component.
 *
 * Note: This adapter is re-exported from each menu package for convenience.
 * Import from the specific menu package you're using rather than from @bazza-ui/menu directly.
 *
 * @example Usage with command-menu
 * ```tsx
 * import { LoaderAdapterProvider, ReactQueryLoaderAdapter, createLoader } from '@bazza-ui/command-menu/loaders/tanstack-query'
 *
 ...
 * ```
 *
 * @example Usage with context-menu
 * ```tsx
 * import { LoaderAdapterProvider, ReactQueryLoaderAdapter, createLoader } from '@bazza-ui/context-menu/loaders/tanstack-query'
 *
 * <LoaderAdapterProvider adapter={ReactQueryLoaderAdapter}>
...
/**
 * Creates a type-safe async loader for menus that integrates with React Query.
 *
 ...
 *
 * Note: This function is re-exported from each menu package for convenience.
 * Import from the specific menu package you're using rather than from @bazza-ui/menu directly.
 *
 ...
 * @returns A typed loader function compatible with any menu component
 *
 * @example Basic usage with command-menu
 * ```tsx
 ...
 * ```
 *
 * @example Basic usage with context-menu
 * ```tsx
 * import { createLoader } from '@bazza-ui/context-menu/loaders/tanstack-query'
 *
 * loader: createLoader(({ query }) => ({
 *   queryKey: ['items', query],
 *   queryFn: () => fetchItems(query),
