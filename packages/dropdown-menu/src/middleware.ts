/**
 * Dropdown menu-specific middleware helpers.
 * These helpers provide properly typed control parameters for PopupMenuControl.
 *
 * Note: Dropdown menus use PopupMenuControl since they share the same underlying
 ...
 * @example
 * ```tsx
 * import { createNew } from '@bazza-ui/dropdown-menu/middleware'
 *
 ...
 * @example
 * ```tsx
 * import { composeMiddleware, createNew } from '@bazza-ui/dropdown-menu/middleware'
 *
