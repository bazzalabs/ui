/**
 * Command score algorithm from cmdk.
 * Provides fuzzy matching for menu item filtering.
 */
...
function commandScoreInner(
  ...
  while (index >= 0) {
    ...
    if (
      ...
      (lowerAbbreviation.charAt(abbreviationIndex + 1) ===
        lowerAbbreviation.charAt(abbreviationIndex) && // allow duplicate letters
        lowerString.charAt(index - 1) !==
...
/**
 * Score a string against an abbreviation using fuzzy matching.
 * Returns a score between 0 and 1, where 1 is a perfect match.
 *
 * @param string - The string to score
 * @param abbreviation - The search query
 * @param aliases - Optional aliases to include in matching
